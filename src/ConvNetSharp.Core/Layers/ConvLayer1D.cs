...
{
    public class ConvLayer1D<T> : LayerBase<T>, IDotProductLayer<T> where T : struct, IEquatable<T>, IFormattable
    {
        private T _biasPref;
        private int _xpad;
        private int _ypad;
        ...
        public ConvLayer1D(Dictionary<string, object> data) : base(data)
        {
        ...
        public ConvLayer1D(int width, int height, int filterCount)
        {
